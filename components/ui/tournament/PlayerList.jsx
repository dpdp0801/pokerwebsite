            ...
            <li key={registration.id} className="p-3 flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {isAdmin && registration.user.venmoId && (
                      <p className="text-sm text-muted-foreground">Venmo: {registration.user.venmoId}</p>
                    )}
                    
                    {/* Tournament buy-ins display */}
                    {!isCashGame && registration.rebuys > 0 && (
                      <span className="text-sm px-1.5 py-0.5 bg-purple-100 text-purple-800 rounded-full">
                    ...
                    {isCashGame && registration.buyInTotal > 0 && (
                      <span className="text-sm px-1.5 py-0.5 bg-green-100 text-green-800 rounded-full">
                    ...
                    {isCashGame && registration.cashOut !== null && (
                      <span className="text-sm px-1.5 py-0.5 bg-blue-100 text-blue-800 rounded-full">
              ...
              <div className="flex items-center space-x-1">
                ...
                {isITM && registration.prize && (
                  <div className="mr-2 text-base font-medium text-green-600">
                    ${registration.prize}
                  </div>
                )}
