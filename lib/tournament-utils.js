...
export const shouldShowPayouts = (blindStructureData, currentSession) => {
  ...
  // Add additional null check for blindStructureData.currentLevel
  if (!blindStructureData.currentLevel) {
    return false;
  }
  ...
  // Add null check for blindStructureData.levels
  if (!blindStructureData.levels) {
    return false;
  }
