...
export function getBlindStructure() {
  console.warn("getBlindStructure from lib/structures is deprecated. Use API route /api/blinds/structure or useBlindStructure hook instead.");
  return null; // Or return a default empty structure
}

export function getAllPayoutStructures() {
  console.warn("getAllPayoutStructures from lib/structures is deprecated. Use API route /api/payout-structures or usePayoutStructure hook instead.");
